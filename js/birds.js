...
const BIRDS = [
  ...
  },
  {
    ...
    lure: { food:"safflower", structure:"platform" },
  ...
  },
  {
    ...
    lure: { food:"peanut", structure:"peanut_post" },
  ...
  },
  {
    ...
    lure: { food:"fruit", structure:"fruit_tree", season:0 },
  ...
  { id:"scarlet_tanager", name:"Scarlet Tanager", area:"forest", rarity:"rare", points:8,
    foods:["fruit","nectar"], lure:{ food:"fruit", structure:"berry_thicket" },
  ...
  { id:"pileated_woodpecker", name:"Pileated Woodpecker", area:"forest", rarity:"rare", points:10,
    foods:["suet"], lure:{ food:"suet", structure:"suet_log" },
    desc:"Crow-sized and dramatic, with a flaming red crest and a ringing call.",
  ...
  { id:"baltimore_oriole", name:"Baltimore Oriole", area:"forest", rarity:"legendary", points:16,
    foods:["nectar","fruit"], lure:{ food:"nectar", structure:"oriole_feeder", season:1 },
  ...
  { id:"belted_kingfisher", name:"Belted Kingfisher", area:"wetland", rarity:"rare", points:9,
    foods:["mealworm","seed"], lure:{ food:"mealworm", structure:"fishing_perch" }, rainLover:true,
    desc:"A shaggy-crested, big-billed angler that rattles as it patrols the shore.",
  ...
  { id:"great_blue_heron", name:"Great Blue Heron", area:"wetland", rarity:"legendary", points:18,
    foods:["mealworm"], lure:{ food:"mealworm", structure:"reed_pool", weather:"rain" }, rainLover:true,
    desc:"Statuesque and patient, a slate-blue giant stalking the shallows.",
  ...
  { id:"pine_grosbeak", name:"Pine Grosbeak", area:"mountain", rarity:"rare", points:8,
    foods:["seed","fruit"], lure:{ food:"fruit", structure:"pine_bough" },
    desc:"A plump, rosy-red finch of the cold conifers, gentle and unhurried.",
  ...
  { id:"gray_crowned_rosy_finch", name:"Gray-crowned Rosy-Finch", area:"mountain", rarity:"rare", points:9,
    foods:["nyjer","seed"], lure:{ food:"nyjer", structure:"cliff_patch" },
    desc:"A hardy alpine wanderer, brown and frosted with rosy pink.",
    shape:{ size:0.9 },
  ...
  { id:"golden_eagle", name:"Golden Eagle", area:"mountain", rarity:"legendary", points:22,
    foods:["suet"], lure:{ food:"suet", structure:"eagle_eyrie", season:3 },
    desc:"Master of the high crags — dark, regal, and crowned with golden nape feathers.",
    shape:{ size:1.34 },
